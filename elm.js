...
Elm.GoogleAnalytics = Elm.GoogleAnalytics || {};
Elm.GoogleAnalytics.make = function (_elm) {
   "use strict";
   _elm.GoogleAnalytics = _elm.GoogleAnalytics || {};
   if (_elm.GoogleAnalytics.values) return _elm.GoogleAnalytics.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Native$GoogleAnalytics = Elm.Native.GoogleAnalytics.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var analytics = function (trackingID) {    return $Native$GoogleAnalytics.analytics(trackingID);};
   return _elm.GoogleAnalytics.values = {_op: _op,analytics: analytics};
};
Elm.Main = Elm.Main || {};
Elm.Main.make = function (_elm) {
   ...
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $GoogleAnalytics = Elm.GoogleAnalytics.make(_elm),
   $Graphics$Element = Elm.Graphics.Element.make(_elm),
   $List = Elm.List.make(_elm),
   $Maybe = Elm.Maybe.make(_elm),
   $Result = Elm.Result.make(_elm),
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var main = function () {    var _p0 = $GoogleAnalytics.analytics("someid");return $Graphics$Element.show("hello world");}();
