...
var _user$project$GoogleAnalytics$analytics = function (id) {
	analytics:
	while (true) {
		var _p0 = A2(
...
var _user$project$GoogleAnalytics$sendID = _elm_lang$core$Native_Platform.outgoingPort(
	'sendID',
	function (v) {
		return v;
	});
	...
	main: _elm_lang$html$Html_App$program(
		{
			init: {
				ctor: '_Tuple2',
				_0: 0,
				_1: _user$project$GoogleAnalytics$analytics('UA-36258407-2')
			},
